...
st.markdown("This app is currently available for: :red[**Term 1 2025**] (Ver1.7c, 10 Jan 2025)")
...
def open_db(filename):
    ...
    worksheet = spread.worksheet("2025T1") #CHANGE THIS WHEN CHANGING TERM DATABASES!!!
